...
- **해결 과정:**
    ...
    - 이로 인해 리졸버가 무시(Bypass)되면서 비어있는 더미 MemberDto(id=1)가 컨트롤러로 계속 바인딩되어 발생한 문제였음. 코드를 올바르게 수정.
- **결과:**
...
| Label | #Sample | Average | Min | Max | Std.Dev. | Error% | Throughput | Received KB/sec | Sent KB/sec | Avg.Bytes |
|---| --- | --- | --- | --- | --- |--------| --- | --- | --- | --- |
| 회원가입 | 1000 | 1027 | 13 | 2143 | 465.6489030063316 | 0.20   | 401.92926045016077 | 159.22247098573152 | 173.05488218448554 | 05.653 |
